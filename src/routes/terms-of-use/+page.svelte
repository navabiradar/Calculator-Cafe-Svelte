    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Calculator Cafe, accessible from
              <a
                href="https://calculator.cafe/"
                rel="external nofollow noopener"
                target="_blank">https://calculator.cafe/</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            By visiting this page on our website: <a
              href="https://calculator.cafe/contact-us"
              rel="external nofollow noopener"
              >https://calculator.cafe/contact-us</a>
          </li>
        </ul>
      </div>
    </div>
